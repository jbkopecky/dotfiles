...
" =============================================================================
let s:base03 = [ '#808070', 244 ]
let s:base02 = [ '#949484', 246 ]
let s:base01 = [ '#a8a897', 248 ]
let s:base00 = [ '#e8e8d3', 253 ]
let s:base0 = [ '#151513', 233 ]
let s:base1 = [ '#30302c', 236 ]
let s:base2 = [ '#4e4e43', 239 ]
let s:base3 = [ '#666656', 242 ]
